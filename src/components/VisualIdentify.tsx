...
const supportedTypes: Record<string, ImageData> = {
  ...
  'pasithea': { cmdr: 'AeroMech91', location: `Vadim Point - Col 285 Sector VZ-P c5-10, C D 6`, more: [{ n: 'pasithea-two.jpg', c: 'Cmdr AeroMech91', l: `Vadim Point - Col 285 Sector VZ-P c5-10, C D 6` }] },
