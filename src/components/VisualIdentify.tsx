...
const supportedTypes: Record<string, ImageData> = {
  ...
  'astraeus': { cmdr: 'Disnaematter', location: `Palmer Relay - Synuefe EM-M c23-8` },
  'athena': { cmdr: 'PhoenixBlue', location: 'Vela Dark Region HH-V c2-29, B 1' },
  ...
  'eunomia': { cmdr: 'Disnaematter', location: `Gonnessiat Platform - Synuefe EM-M c23-8` },
  ...
  'fauna': { cmdr: 'AeroMech91', location: `Barnett Range - Col 285 Sector VZ-P c5-10, CD 4 A` },
  ...
  'mefitis': { cmdr: 'AeroMech91', location: `Goswami Anchor - Col 285 Sector VZ-P c5-10, AB 3 A` },
  ...
  'pasithea': { cmdr: 'AeroMech91', location: `Vadim Point - Col 285 Sector VZ-P c5-10, CD 6`, more: [{ n: 'pasithea-two.jpg', c: 'Cmdr AeroMech91', l: `Vadim Point - Col 285 Sector VZ-P c5-10, CD 6` }] },
