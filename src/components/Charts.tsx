...
export const ChartGeneralProgress: FunctionComponent<{ progress: number, readyOnFC: number, maxNeed: number, minimal?: boolean }> = (props) => {
  ...
  return <div className="chart" >
    <StackedBarChart
      ...
      data={{
        chartTitle: props.minimal ? undefined : `Total progress:`,
        chartData: points,
      }}
    />
  </div>;
