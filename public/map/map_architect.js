var map = {
  ...
  /*
  data: {
    "categories": { "Filter": { "1": { "name": "Favourite", "color": "ffff00" }, "2": { "name": "Building", "color": "ff0000" }, "3": { "name": "Planning", "color": "0000ff" } } },
    // categories: {
    //   'Status': {
    //     '1': { name: 'Complete', color: '00ff00', },
    //     '2': { name: 'Building', color: 'ff0000', },
    //     '3': { name: 'Planning', color: '0000ff', },
    //   },
    // },
    systems: [
      { "name": "Sol", "coords": { "x": 0, "y": 0, "z": 0 }, "cat": [10] },
      { "name": "Solati", "coords": { "x": 66.53125, "y": 29.1875, "z": 34.6875 }, "cat": [20, 10] }
    ],
    routes: [
      {
        "title": "3rd test route",
        "points": [
          { "s": "Sol" },
          { "s": "Solati" },
          // { "s": "Checkpoint 6" }
